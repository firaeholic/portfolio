...
function App() {
  ...
  const [visibleSections, setVisibleSections] = useState([0, 1, 2, 3])
  ...
  const projects = [
    ...
    { id: 'ecommerce', name: 'E-commerce', description: 'Landing Page', extra: "E-commerce Site" },
  ...
  const skills = {
    ...
    mobile: ['Flutter', 'Cypress'],
    architecture: ['Clean Architecture', 'Model-View-Controller (MVC)', 'DDD'],
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-violet-900 text-white">
          ...
          {projects.map((project) => (
            ...
            >
              <div className="aspect-video w-full rounded-lg bg-gray-700 overflow-hidden flex items-center justify-center">
                <img 
                  src={`/src/projects/${project.name}/${project.description}.png`}
      ...
      <section className="py-20 px-8 bg-black/20" id="skills">
        ...
        <div className="max-w-4xl mx-auto grid gap-8 place-items-center">
          ...
          <div className="w-full space-y-6">
            <h3 className="text-2xl font-semibold mb-4 text-center">Version Control</h3>
            <div className="flex flex-wrap gap-4 justify-center">
